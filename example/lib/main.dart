...
import 'package:custom_radio/radioButtons.dart';
...
class _MyHomePageState extends State<MyHomePage>
  ...
  _MyHomePageState() {
    customBuilder = (BuildContext context, List<dynamic> animValues,
      ...
      /*ListView(
        children: <Widget>[
           CustomRadio<String, dynamic>(
              value: 'Green',
              currentGroupValue: widget.radioValue,
          ...
          CustomRadio<String, dynamic>(
            ...
            animsBuilder: (AnimationController controller) => [
              ...
              ColorTween(
                      begin: Colors.redAccent.withAlpha(200), end: Colors.red)
                  .animate(controller),
            ],
            builder: customBuilder,
          ),
          CustomRadio<String, dynamic>(
            ...
            animsBuilder: (AnimationController controller) => [
              ...
              ColorTween(
                      begin: Colors.blueAccent.withAlpha(200), end: Colors.blue)
                  .animate(controller),
            ],
            builder: customBuilder,
          ),
